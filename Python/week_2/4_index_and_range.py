...
print("letters from the beatle song: " + beatles[3:15])
...
for num in grades:
    print("The first element in the list is " + str(grades[0,3]) + "and the last element in the array is " + str(grades[-1]))
