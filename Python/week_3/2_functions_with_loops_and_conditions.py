...
color_name = dict(zip(adjective, fruits))
print("my list", color_name)
##################################################################################################
...
insertion_sort(arr)
print(sorted(arr)) #my own solution
##################################################################################################
...
print(the_office["Season 3"]["Episode 6"])

# TODO: Question 3: Loop through the the_office object and print out the value of each key.
for season in the_office:
    seasonValue = the_office[season]
    for episode in seasonValue:
        print(seasonValue[episode])
...
for season in the_office:
    seasonValue = the_office[season]
    for episode in seasonValue:
        print(episode, "of", season, "is titled", seasonValue[episode])
...
print("techer", math_classes[0]['teacher'], "teaches", math_classes[0]['students'])
